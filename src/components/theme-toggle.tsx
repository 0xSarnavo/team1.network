...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-transparent text-zinc-900 hover:bg-zinc-900 hover:text-white dark:border-zinc-800 dark:text-white dark:hover:bg-white dark:hover:text-black transition-colors duration-300"
