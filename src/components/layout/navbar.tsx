        ...
        <div className="flex items-center gap-3">
          ...
          {loading ? (
            ...
            <div className="relative">
              {/* Notification bell */}
              <Link href="/notifications" className="mr-3 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200">
              ...
              {profileOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full z-20 mt-2 w-56 rounded-lg border border-zinc-200 bg-white py-2 shadow-xl dark:border-zinc-800 dark:bg-zinc-900">
          ...
          {/* Mobile hamburger */}
          <button className="ml-2 text-zinc-600 dark:text-zinc-400 md:hidden" onClick={() => setMenuOpen(!menuOpen)}>
        ...
        <div className="border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950 md:hidden">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="block px-4 py-3 text-sm text-zinc-600 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-900"
