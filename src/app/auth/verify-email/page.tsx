  ...
  if (!token) {
    return (
      <div className="rounded-2xl border border-zinc-200 bg-white p-8 text-center shadow-sm dark:border-zinc-800 dark:bg-black">
        <svg className="mx-auto mb-4 h-12 w-12 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-8 text-center shadow-sm dark:border-zinc-800 dark:bg-black">
      {status === 'verifying' && (
        <>
          ...
          <h1 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Verifying your email...</h1>
        </>
      )}
      {status === 'success' && (
        <>
          ...
          <h1 className="mb-2 text-2xl font-bold text-zinc-900 dark:text-zinc-100">Email Verified!</h1>
      ...
      {status === 'error' && (
        <>
          <svg className="mx-auto mb-4 h-12 w-12 text-red-500 dark:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <h1 className="mb-2 text-2xl font-bold text-zinc-900 dark:text-zinc-100">Verification Failed</h1>
          <p className="text-sm text-zinc-500">{message}</p>
          <Link href="/auth/login">
            <Button variant="ghost" className="mt-6">Back to Sign In</Button>
          </Link>
